    ...
    plugins: [
        laravel({
            input: [
                ...
                'resources/js/galactic-tycoons/buildings-systems.js',
                'resources/js/galactic-tycoons/buildings-upkeep.js',
                'resources/js/galactic-tycoons/buildings-workforce.js',
